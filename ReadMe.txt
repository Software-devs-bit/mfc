...
In the toolbar in the application program there is a combobox with these three view options. By default 'Main View' is selected. This combobox is used to control the view display. The selected view(in combobox) will get displayed on the client area of the main frame window.
